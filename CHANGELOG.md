...
- **Navbar styling**: solid background with subtle downward shadow, removed gradient fade, zero top padding for a cleaner look

## [1.5.3] - 2026-02-16

### Changed

- Knowledge base defaults: 25 files max (was 100), 4 images per file (was 10)
- Collection image limit display: denominator is now `max_images × max_files` (e.g. 4×25=100)

## [1.5.2] - 2026-02-16

### Added

- **Knowledge list counts**: knowledge base cards show doc count/limit and image count/limit next to the "Collection" badge
- File and image counts computed efficiently via batch queries in the knowledge list API
